...
from .epsilon_schedules import DecayThenFlatScheduleRoles
REGISTRY = {}
...
class SoftEpsilonGreedyActionSelector():
    ...
    def __init__(self, args):
        ...
        self.schedule = DecayThenFlatScheduleRoles(args.epsilon_start, args.epsilon_finish, args.epsilon_anneal_time,
